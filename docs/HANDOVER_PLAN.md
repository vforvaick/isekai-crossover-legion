...
### ❌ What's Missing
| Feature | Estimated Effort | Phase | Status |
|---------|-----------------|-------|--------|
| GitHub Auth env vars | 10 min | Phase 1 | ✅ DONE |
| Schema alignment with reference | 30 min | Phase 2 | ✅ DONE |
| Agent roster cleanup (13 → 7+6 dormant) | 20 min | Phase 3 | ✅ DONE |
| Task Create/Edit/Delete UI | 3-4 hours | Phase 4 | ✅ DONE |
| Board filtering in Kanban | 1-2 hours | Phase 5 | ✅ DONE |
| Agent detail pages | 2-3 hours | Phase 6 | ✅ DONE |
| Threaded comments | 2-3 hours | Phase 7 | ⏳ PENDING |
| Agent messages viewer | 1-2 hours | Phase 8 | ⏳ PENDING |
| Heartbeat visualization | 1-2 hours | Phase 9 | ✅ DONE |
| Dashboard overview widgets | 2-3 hours | Phase 10 | ⏳ PENDING |
| Polish (avatars, theme, notifications) | 2-4 hours | Phase 11 | ⏳ PENDING |
