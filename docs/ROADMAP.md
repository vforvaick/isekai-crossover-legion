...
## Recently Completed
- **Agent roster alignment & cleanup** (2026-02-11) — 7 active agents synced with PERSONAS.md, migration executed.
- **Task CRUD & Board Filtering** (2026-02-11) — Create/Edit/Delete tasks and domain-based Kanban filtering.
- **Agent Detail Pages** (2026-02-11) — Rich detail view for each agent with health metrics.
- **Heartbeat Visualization** (2026-02-11) — Real-time pulse indicators in agent cards.
